...
$config['authentication'] = function () {
    return true; // dari false jadikan true
};

/*============================ License Key ============================================*/
// https://ckeditor.com/docs/ckfinder/ckfinder3-php/configuration.html#configuration_options_licenseKey

$config['licenseName'] = 'zai.web.id'; // masukan ini
$config['licenseKey']  = 'T6P6DVJCGEQ55H9ENHWL7BF8SC6EL'; // masukan ini
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => 'http://localhost/web_desa/public/theme/images', //tempat penyimpanan gambar,
